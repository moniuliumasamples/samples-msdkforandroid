...
import com.moniuliuma.fingerprint.ReaderCollection;
import com.moniuliuma.fingerprint.FingerprintManagerCompat;
import com.moniuliuma.fingerprint.Reader.Capabilities;
...
public class Globals 
{
	...
	public Reader getReader(String name, Context applContext) throws DeviceException
	{
	...
	public ReaderCollection getReaders(Context applContext) throws DeviceException
	{
		readers = FingerprintManagerCompat.GetReaderCollection(applContext);
		readers.GetReaders();
		return readers;
	}
	public void releaseReaders()  throws DeviceException {
		if(readers != null)
			FingerprintManagerCompat.DestroyReaderCollection();
	}
