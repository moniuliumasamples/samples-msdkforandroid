...
import com.moniuliuma.fingerprint.Engine;
import com.moniuliuma.fingerprint.Fid;
import com.moniuliuma.fingerprint.Fmd;
...
public class VerificationActivity extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		try 
		{
			...
			m_engine = FingerprintManagerCompat.GetEngine();
		} 
		catch (Exception e)
		{
			...
			public void run()
			{
				...
				while (!m_reset)
				{
					...
					try 
					{
						...
						Log.w("UareUSampleJava", "Engine error: GetBitmapFromRaw " );
						if (m_fmd == null)
						{
							m_fmd = m_engine.CreateFmd(cap_result.image, Fmd.Format.ANSI_378_2004);
						}
						else
						{	Log.w("UareUSampleJava", "Engine  Compare " );
						...
						Log.w("UareUSampleJava", "Engine Compare m_resultAvailableToDisplay " + m_resultAvailableToDisplay);
					}
					catch (Exception e)
					{
